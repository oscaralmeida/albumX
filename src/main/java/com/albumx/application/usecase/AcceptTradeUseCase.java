...
@Component
public class AcceptTradeUseCase {

    private final TradeService tradeService;

    public AcceptTradeUseCase(TradeService tradeService) {
        this.tradeService = tradeService;
    }

    @Transactional
    public TradeProposalResponse execute(UUID tradeId, TradeActionRequest request) {
        TradeProposal proposal = tradeService.acceptProposal(tradeId, request.targetUserId());
